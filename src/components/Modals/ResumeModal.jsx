    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
        ...
        <motion.div
          ...
          className="relative w-full max-w-5xl glass-panel bg-[#090f1e]/98 rounded-3xl border border-slate-700/80 p-5 sm:p-8 shadow-2xl z-10 my-6 overflow-hidden max-h-[95vh] flex flex-col text-slate-200"
        >
          {/* Header Action Bar */}
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-[11px] font-mono text-cyan-400 uppercase tracking-widest flex items-center gap-1">
                  <FileText className="w-3 h-3" /> Official Resume • Google Drive Verified
                </span>
                <h2 className="text-xl sm:text-2xl font-bold text-white font-heading">{personalDetails.name}</h2>
              </div>
            </div>
          ...
          <div className="flex-1 w-full min-h-[65vh] rounded-2xl border border-slate-800 overflow-hidden bg-[#030712] relative">
            <iframe
          ...
          <div className="mt-4 pt-4 border-t border-slate-800 flex flex-wrap items-center justify-between gap-3 shrink-0">
            <div className="text-xs text-slate-300 font-medium flex items-center gap-2">
              <Sparkles className="w-4 h-4 text-cyan-400 shrink-0" />
              <span>Eager to learn, build, and solve real-world problems through software and AI.</span>
            </div>
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-cyan-500 via-indigo-500 to-violet-600 text-white font-semibold text-xs shadow-lg shadow-cyan-500/25 hover:scale-105 transition-all"
              >
